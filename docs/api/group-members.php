...
<div class="sidenav">
    ...
    <a class="selectedPage" href="group-members.php">Group Members</a>
    <section class="subSection">
      <?php
      require __DIR__ . '/ResourceDoc.php';
      $actionTitles = ResourceDoc::getActionTitles("group-members");
...
<?php
ResourceDoc::printDocumentation("group-members");
?>
1
